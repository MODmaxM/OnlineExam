...
public class TeacherInfoServiceImpl implements TeacherInfoService {
	...
	public TeacherInfo getTeacherByAccount(String teacherAccount) {
		System.out.println("getTeacherByAccount " + teacherAccount + " 在serviceImpl中");
		TeacherInfo tf = teacherInfoMapper.getTeacherByAccount(teacherAccount);
		System.out.println(tf.getTeacherName() + tf.getTeacherAccount() + "老师正在login");
		return tf;
	}
